...
Macro definitions
***********************************************************************************************************************/
#define LCD_REFVOLTAGE_WAITTIME           (800U) /* wait for the reference voltage setup time (5 ms (min.)) */
#define LCD_VOLTAGE_WAITTIME              (80000U) /* voltage boost wait time (500 ms) */
#endif
