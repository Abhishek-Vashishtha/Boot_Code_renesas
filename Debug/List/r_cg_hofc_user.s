...
//        BootCode\source_code\driver_files\r_cg_hofc_user.c
//    Command line       =
//        -f C:\Users\laptop\AppData\Local\Temp\EWDE4F.tmp ("D:\Dheeraj\New
//        folder\0. GDEV72 -
//        BootCode\source_code\driver_files\r_cg_hofc_user.c" --core s3
...
//    List file          =
//        D:\Dheeraj\New folder\0. GDEV72 -
//        BootCode\Debug\List\r_cg_hofc_user.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN ___interrupt_tab_0x1A

        PUBLIC _R_HOFC_Create_UserInit
...
// D:\Dheeraj\New folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_hofc_user.c
//    1 /***********************************************************************************************************************
//    2 * DISCLAIMER
...
//   27 ***********************************************************************************************************************/
//   28 extern unsigned char last_interrupt;
//   29 /***********************************************************************************************************************
//   30 Includes
//   31 ***********************************************************************************************************************/
...
//   49 
//   50 /***********************************************************************************************************************
//   51 * Function Name: R_HOFC_Create_UserInit
//   52 * Description  : This function adds user code after initializing HOFC module.
//   53 * Arguments    : None
...
//   55 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_HOFC_Create_UserInit
          CFI NoCalls
        CODE
//   56 void R_HOFC_Create_UserInit(void)
//   57 {
_R_HOFC_Create_UserInit:
...
//   60 }
        ...
        ; ------------------------------------- Total: 6 cycles
//   61 /***********************************************************************************************************************
//   62 * Function Name: r_hofc_interrupt
//   63 * Description  : None
//   64 * Arguments    : None
//   65 * Return Value : None
//   66 ***********************************************************************************************************************/
//   67 #pragma vector = INTCR_vect

        SECTION `.text`:CODE:NOROOT(0)
        CALL_GRAPH_ROOT _r_hofc_interrupt, "interrupt"
          CFI Block cfiBlock1 Using cfiCommon1
          CFI Function _r_hofc_interrupt
          CFI NoCalls
        CODE
//   68 __interrupt static void r_hofc_interrupt(void)
//   69 {
_r_hofc_interrupt:
___interrupt_0x1A:
        ; * Stack frame (at entry) *
...
//   71   last_interrupt = 6;
        MOV       N:_last_interrupt, #0x6  ;; 1 cycle
//   72   NOP();
        NOP                          ;; 1 cycle
...
//   74 }
        ...
        END
//   75 
//   76 /* Start user code for adding. Do not edit comment generated here */
