///////////////////////////////////////////////////////////////////////////////
//
// IAR C/C++ Compiler V4.20.1.2260 for RL78               20/Dec/2020  22:38:57
...
//        BootCode\source_code\driver_files\r_cg_rtc_user.c
//    Command line       =
//        -f C:\Users\laptop\AppData\Local\Temp\EWF350.tmp ("D:\Dheeraj\New
//        folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_rtc_user.c"
...
//    Locale             =  C
//    List file          =
//        D:\Dheeraj\New folder\0. GDEV72 - BootCode\Debug\List\r_cg_rtc_user.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN ___interrupt_tab_0x3A

        PUBLIC _R_RTC_Create_UserInit
        PUBLIC ___interrupt_0x3A
        PUBLIC _g_rtc_binary_rtcic0
        PUBLIC _g_rtc_binary_rtcic1
        PUBLIC _g_rtc_binary_rtcic2
        PUBLIC _g_rtc_calendar_rtcic0
        PUBLIC _g_rtc_calendar_rtcic1
        PUBLIC _g_rtc_calendar_rtcic2
...
// D:\Dheeraj\New folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_rtc_user.c
//    1 /***********************************************************************************************************************
//    2 * DISCLAIMER
...
//   43 extern us8 last_interrupt;
//   44 /***********************************************************************************************************************
//   45 Global variables and functions
//   46 ***********************************************************************************************************************/

        SECTION `.bss`:DATA:REORDER:NOROOT(0)
//   47 rtc_capture_value_t g_rtc_calendar_rtcic0;
_g_rtc_calendar_rtcic0:
        DS 5

        SECTION `.bss`:DATA:REORDER:NOROOT(0)
//   48 rtc_capture_value_t g_rtc_calendar_rtcic1;
_g_rtc_calendar_rtcic1:
        DS 5

        SECTION `.bss`:DATA:REORDER:NOROOT(0)
//   49 rtc_capture_value_t g_rtc_calendar_rtcic2;
_g_rtc_calendar_rtcic2:
        DS 5

        SECTION `.bss`:DATA:REORDER:NOROOT(1)
//   50 uint32_t g_rtc_binary_rtcic0;
_g_rtc_binary_rtcic0:
        DS 4

        SECTION `.bss`:DATA:REORDER:NOROOT(1)
//   51 uint32_t g_rtc_binary_rtcic1;
_g_rtc_binary_rtcic1:
        DS 4

        SECTION `.bss`:DATA:REORDER:NOROOT(1)
//   52 uint32_t g_rtc_binary_rtcic2;
_g_rtc_binary_rtcic2:
        DS 4
//   53 /* Start user code for global. Do not edit comment generated here */
//   54 /* End user code. Do not edit comment generated here */
//   55 
//   56 /***********************************************************************************************************************
//   57 * Function Name: R_RTC_Create_UserInit
//   58 * Description  : This function adds user code after initializing the voltage detector.
//   59 * Arguments    : None
...
//   61 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_RTC_Create_UserInit
          CFI NoCalls
        CODE
//   62 void R_RTC_Create_UserInit(void)
//   63 {
_R_RTC_Create_UserInit:
...
//   67 
//   68 /***********************************************************************************************************************
//   69 * Function Name: r_rtc_periodicinterrupt
//   70 * Description  : None
//   71 * Arguments    : None
//   72 * Return Value : None
//   73 ***********************************************************************************************************************/
//   74 #pragma vector = INTRTCRPD_vect

        SECTION `.text`:CODE:NOROOT(0)
        CALL_GRAPH_ROOT _r_rtc_periodicinterrupt, "interrupt"
          CFI Block cfiBlock1 Using cfiCommon1
          CFI Function _r_rtc_periodicinterrupt
          CFI NoCalls
        CODE
//   75 __interrupt static void r_rtc_periodicinterrupt(void)
//   76 {
_r_rtc_periodicinterrupt:
___interrupt_0x3A:
        ; * Stack frame (at entry) *
        ; Param size: 0
        ; Auto size: 0
//   77     /* Start user code. Do not edit comment generated here */
//   78     last_interrupt = 23;
        MOV       N:_last_interrupt, #0x17  ;; 1 cycle
...
//   81 
//   82 ///***********************************************************************************************************************
//   83 //* Function Name: r_rtc_alarminterrupt
//   84 //* Description  : None
//   85 //* Arguments    : None
//   86 //* Return Value : None
//   87 //***********************************************************************************************************************/
//   88 //#pragma vector = INTRTCALM_vect
//   89 //__interrupt static void r_rtc_alarminterrupt(void)
//   90 //{
//   91 //    /* Start user code. Do not edit comment generated here */
//   92 //      last_interrupt = 24;
//   93 //    /* End user code. Do not edit comment generated here */
//   94 //}
//   95 
//   96 /***********************************************************************************************************************
//   97 * Function Name: r_rtc_callback_periodic
//   98 * Description  : This function is real-time clock interrupt service handler.
//   99 * Arguments    : None
//  100 * Return Value : None
//  101 ***********************************************************************************************************************/
//  102 //static void r_rtc_callback_periodic(void)
//  103 //{
...
//  107 
//  108 /***********************************************************************************************************************
//  109 * Function Name: r_rtc_callback_alarm
//  110 * Description  : This function is alarm interrupt service handler.
//  111 * Arguments    : None
//  112 * Return Value : None
//  113 ***********************************************************************************************************************/
//  114 //static void r_rtc_callback_alarm(void)
//  115 //{
//  116 //    /* Start user code. Do not edit comment generated here */
//  117 //    /* End user code. Do not edit comment generated here */
//  118 //}
//  119 
//  120 /* Start user code for adding. Do not edit comment generated here */
