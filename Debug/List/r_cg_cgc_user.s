...
//        BootCode\source_code\driver_files\r_cg_cgc_user.c
//    Command line       =
//        -f C:\Users\17054\AppData\Local\Temp\EWDBB3.tmp ("D:\Software
//        code\Projects Software\Projects new\0. Non AMI\SUGAM Based\0. GDEV72
//        - BootCode-20210104T103109Z-001\0. GDEV72 -
//        BootCode\source_code\driver_files\r_cg_cgc_user.c" --core s3
...
//        D:\Software code\Projects Software\Projects new\0. Non AMI\SUGAM
//        Based\0. GDEV72 - BootCode-20210104T103109Z-001\0. GDEV72 -
//        BootCode\Debug\List\r_cg_cgc_user.s
//
///////////////////////////////////////////////////////////////////////////////
...
// D:\Software code\Projects Software\Projects new\0. Non AMI\SUGAM Based\0. GDEV72 - BootCode-20210104T103109Z-001\0. GDEV72 - BootCode\source_code\driver_files\r_cg_cgc_user.c
//    1 /***********************************************************************************************************************
//    2 * DISCLAIMER
...
//   32 #include "r_cg_macrodriver.h"
        ...
        ASEGN `.bss.noinit`:DATA:NOROOT,0fffa8H
        SECTION_TYPE SHT_IAR_NOINIT, SHF_WRITE
        SECTION_GROUP __A_RESF
// __no_init union <unnamed>#105 const volatile __sfr __no_bit_access _A_RESF
__A_RESF:
        DS 1
...
//   48 
//   49 /***********************************************************************************************************************
//   50 * Function Name: R_CGC_Create_UserInit
//   51 * Description  : This function adds user code after initializing the clock generator.
//   52 * Arguments    : None
...
//   54 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_CGC_Create_UserInit
          CFI NoCalls
        CODE
//   55 void R_CGC_Create_UserInit(void)
//   56 {
...
//   59 }
        ...
        ; ------------------------------------- Total: 6 cycles
//   60 /***********************************************************************************************************************
//   61 * Function Name: R_CGC_Get_ResetSource
//   62 * Description  : This function process of Reset.
//   63 * Arguments    : None
...
//   65 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_CGC_Get_ResetSource
          CFI NoCalls
        CODE
//   66 void R_CGC_Get_ResetSource(void)
//   67 {
_R_CGC_Get_ResetSource:
        ; * Stack frame (at entry) *
        ; Param size: 0
        ; Auto size: 0
//   68     uint8_t reset_flag = RESF;
        MOV       A, 0xFFFA8         ;; 1 cycle
...
//   71 }
        ...
        END
//   72 
//   73 /* Start user code for adding. Do not edit comment generated here */
