///////////////////////////////////////////////////////////////////////////////
//
// IAR C/C++ Compiler V4.20.1.2260 for RL78               20/Dec/2020  22:38:51
...
//        BootCode\source_code\driver_files\r_cg_fmc_user.c
//    Command line       =
//        -f C:\Users\laptop\AppData\Local\Temp\EWDB41.tmp ("D:\Dheeraj\New
//        folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_fmc_user.c"
...
//    Locale             =  C
//    List file          =
//        D:\Dheeraj\New folder\0. GDEV72 - BootCode\Debug\List\r_cg_fmc_user.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN ___interrupt_tab_0x30
        EXTERN _freq_measured

        PUBLIC _R_FMC_Create_UserInit
        PUBLIC __A_FMCRH
        PUBLIC __A_FMCRL
...
// D:\Dheeraj\New folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_fmc_user.c
//    1 /***********************************************************************************************************************
//    2 * DISCLAIMER
...
//   32 #include "r_cg_macrodriver.h"
        ...
        ASEGN `.bss.noinit`:DATA:NOROOT,0f0312H
        SECTION_TYPE SHT_IAR_NOINIT, SHF_WRITE
        SECTION_GROUP __A_FMCRL
// __no_init union <unnamed>#536 const volatile __no_bit_access _A_FMCRL
__A_FMCRL:
        DS 2

        ASEGN `.bss.noinit`:DATA:NOROOT,0f0314H
        SECTION_TYPE SHT_IAR_NOINIT, SHF_WRITE
        SECTION_GROUP __A_FMCRH
// __no_init union <unnamed>#537 const volatile __no_bit_access _A_FMCRH
__A_FMCRH:
        DS 2
...
//   49 
//   50 /***********************************************************************************************************************
//   51 * Function Name: R_FMC_Create_UserInit
//   52 * Description  : This function adds user code after initializing the subsystem clock frequency measurement circuit.
//   53 * Arguments    : None
...
//   55 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_FMC_Create_UserInit
          CFI NoCalls
        CODE
//   56 void R_FMC_Create_UserInit(void)
//   57 {
_R_FMC_Create_UserInit:
...
//   60 }
        ...
        ; ------------------------------------- Total: 6 cycles
//   61 /***********************************************************************************************************************
//   62 * Function Name: r_fmc_interrupt
//   63 * Description  : None
//   64 * Arguments    : None
//   65 * Return Value : None
//   66 ***********************************************************************************************************************/
//   67 #pragma vector = INTFM_vect

        SECTION `.text`:CODE:NOROOT(0)
        CALL_GRAPH_ROOT _r_fmc_interrupt, "interrupt"
          CFI Block cfiBlock1 Using cfiCommon1
          CFI Function _r_fmc_interrupt
        CODE
//   68 __interrupt static void r_fmc_interrupt(void)
//   69 {
_r_fmc_interrupt:
___interrupt_0x30:
        ; * Stack frame (at entry) *
...
//   71   last_interrupt = 5;
        MOV       N:_last_interrupt, #0x5  ;; 1 cycle
//   72   freq_measured = FMCRH;
        MOVW      AX, 0x314          ;; 1 cycle
        MOVW      BC, #0x0           ;; 1 cycle
        MOVW      N:_freq_measured, AX  ;; 1 cycle
        XCHW      AX, BC             ;; 1 cycle
        MOVW      N:_freq_measured+2, AX  ;; 1 cycle
        XCHW      AX, BC             ;; 1 cycle
//   73   freq_measured *= 65536;
        MOVW      AX, #0x1           ;; 1 cycle
        PUSH      AX                 ;; 1 cycle
          CFI CFA SP+12
        MOVW      AX, #0x0           ;; 1 cycle
        PUSH      AX                 ;; 1 cycle
          CFI CFA SP+14
        MOVW      BC, N:_freq_measured+2  ;; 1 cycle
        MOVW      AX, N:_freq_measured  ;; 1 cycle
        ...
        MOVW      N:_freq_measured+2, AX  ;; 1 cycle
        XCHW      AX, BC             ;; 1 cycle
//   74   freq_measured |= FMCRL;
        MOVW      AX, 0x312          ;; 1 cycle
        MOVW      BC, #0x0           ;; 1 cycle
        PUSH      BC                 ;; 1 cycle
          CFI CFA SP+16
        PUSH      AX                 ;; 1 cycle
...
//   77 }
        ...
        END
//   78 
//   79 /* Start user code for adding. Do not edit comment generated here */
