...
//        BootCode\source_code\driver_files\r_cg_hofc.c
//    Command line       =
//        -f C:\Users\laptop\AppData\Local\Temp\EWDC3C.tmp ("D:\Dheeraj\New
//        folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_hofc.c"
...
//    Locale             =  C
//    List file          =
//        D:\Dheeraj\New folder\0. GDEV72 - BootCode\Debug\List\r_cg_hofc.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN _R_HOFC_Create_UserInit

        PUBLIC _R_HOFC_Create
        PUBLIC _R_HOFC_Start
        PUBLIC _R_HOFC_Stop
        PUBLIC __A_HOCOFC
        PUBLIC __A_IF0
        PUBLIC __A_MK0
...
// D:\Dheeraj\New folder\0. GDEV72 - BootCode\source_code\driver_files\r_cg_hofc.c
//    1 /***********************************************************************************************************************
//    2 * DISCLAIMER
...
//   19 
//   20 /***********************************************************************************************************************
//   21 * File Name    : r_cg_hofc.c
//   22 * Version      : Applilet4 for RL78/I1C V1.01.02.04 [24 May 2018]
//   23 * Device(s)    : R5F10NPJ
//   24 * Tool-Chain   : IAR Systems icc78k0r
//   25 * Description  : This file implements device driver for HOFC module.
//   26 * Creation Date: 02/27/2020
//   27 ***********************************************************************************************************************/
//   28 
//   29 /***********************************************************************************************************************
//   30 Includes
...
__A_MK0:
        ...
        ASEGN `.bss.noinit`:DATA:NOROOT,0f02d8H
        SECTION_TYPE SHT_IAR_NOINIT, SHF_WRITE
        SECTION_GROUP __A_HOCOFC
// __no_init union <unnamed>#510 volatile __no_bit_access _A_HOCOFC
__A_HOCOFC:
        DS 1
//   33 #include "r_cg_hofc.h"
...
//   49 
//   50 /***********************************************************************************************************************
//   51 * Function Name: R_HOFC_Create
//   52 * Description  : This function initializes the HOFC module.
//   53 * Arguments    : None
...
//   55 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_HOFC_Create
        CODE
//   56 void R_HOFC_Create(void)
//   57 {
_R_HOFC_Create:
        ; * Stack frame (at entry) *
        ; Param size: 0
        ; Auto size: 0
//   58     CRMK = 1U;      /* disable INTCR interrupt */
        SET1      0xFFFE5.3          ;; 2 cycles
//   59     CRIF = 0U;      /* clear INTCR interrupt flag */
        CLR1      0xFFFE1.3          ;; 2 cycles
//   60     //HOCOFC = _80_HOFC_MODE_INTERMITTENT;
//   61     HOCOFC = _00_HOFC_MODE_CONTINUOUS;
        MOV       0x2D8, #0x0        ;; 1 cycle
//   62     R_HOFC_Create_UserInit();
          CFI FunCall _R_HOFC_Create_UserInit
        CALL      _R_HOFC_Create_UserInit  ;; 3 cycles
//   63 }
        RET                          ;; 6 cycles
        ...
        REQUIRE __A_HOCOFC
//   64 /***********************************************************************************************************************
//   65 * Function Name: R_HOFC_Start
//   66 * Description  : This function starts HOFC module operation.
//   67 * Arguments    : None
...
//   69 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_HOFC_Start
          CFI NoCalls
        CODE
//   70 void R_HOFC_Start(void)
//   71 {
_R_HOFC_Start:
        ; * Stack frame (at entry) *
        ; Param size: 0
        ; Auto size: 0
//   72     HOCOFC |= _01_HOFC_INT_START;
        MOVW      HL, #0x2D8         ;; 1 cycle
        MOV       A, [HL]            ;; 1 cycle
        OR        A, #0x1            ;; 1 cycle
        MOV       [HL], A            ;; 1 cycle
//   73 }
        ...
        REQUIRE __A_HOCOFC
//   74 /***********************************************************************************************************************
//   75 * Function Name: R_HOFC_Stop
//   76 * Description  : This function stops HOFC module operation.
//   77 * Arguments    : None
...
//   79 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_HOFC_Stop
          CFI NoCalls
        CODE
//   80 void R_HOFC_Stop(void)
//   81 {
_R_HOFC_Stop:
        ; * Stack frame (at entry) *
        ; Param size: 0
        ; Auto size: 0
//   82     HOCOFC &= (uint8_t)~_01_HOFC_INT_START;
        MOVW      HL, #0x2D8         ;; 1 cycle
        MOV       A, [HL]            ;; 1 cycle
        AND       A, #0xFE           ;; 1 cycle
        MOV       [HL], A            ;; 1 cycle
//   83 }
        ...
        END
//   84 
//   85 /* Start user code for adding. Do not edit comment generated here */
//   86 /* End user code. Do not edit comment generated here */
// 
//  5 bytes in section .bss.noinit  (abs)
