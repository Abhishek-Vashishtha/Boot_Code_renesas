...
//        BootCode\source_code\driver_files\r_cg_wdt.c
//    Command line       =
//        -f C:\Users\17054\AppData\Local\Temp\EWDDDD.tmp ("D:\Software
//        code\Projects Software\Projects new\0. Non AMI\SUGAM Based\0. GDEV72
//        - BootCode-20210104T103109Z-001\0. GDEV72 -
//        BootCode\source_code\driver_files\r_cg_wdt.c" --core s3 --code_model
...
//        D:\Software code\Projects Software\Projects new\0. Non AMI\SUGAM
//        Based\0. GDEV72 - BootCode-20210104T103109Z-001\0. GDEV72 -
//        BootCode\Debug\List\r_cg_wdt.s
//
///////////////////////////////////////////////////////////////////////////////
...
// D:\Software code\Projects Software\Projects new\0. Non AMI\SUGAM Based\0. GDEV72 - BootCode-20210104T103109Z-001\0. GDEV72 - BootCode\source_code\driver_files\r_cg_wdt.c
//    1 /***********************************************************************************************************************
//    2 * DISCLAIMER
...
//   48 
//   49 /***********************************************************************************************************************
//   50 * Function Name: R_WDT_Create
//   51 * Description  : This function initializes the watchdogtimer.
//   52 * Arguments    : None
...
//   54 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_WDT_Create
        CODE
//   55 void R_WDT_Create(void)
//   56 {
_R_WDT_Create:
...
//   57     WDTIMK = 1U;    /* disable INTWDTI interrupt */
        SET1      0xFFFE4.0          ;; 2 cycles
//   58     WDTIIF = 0U;    /* clear INTWDTI interrupt flag */
        CLR1      0xFFFE0.0          ;; 2 cycles
//   59     WDTIMK = 0U;    /* enable INTWDTI interrupt */
        CLR1      0xFFFE4.0          ;; 2 cycles
//   60 
//   61     R_WDT_Create_UserInit();
          CFI FunCall _R_WDT_Create_UserInit
        CALL      _R_WDT_Create_UserInit  ;; 3 cycles
//   62 }
        RET                          ;; 6 cycles
        ...
        REQUIRE __A_IF0
//   63 /***********************************************************************************************************************
//   64 * Function Name: R_WDT_Restart
//   65 * Description  : This function restarts the watchdog timer.
//   66 * Arguments    : None
...
//   68 ***********************************************************************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(0)
          ...
          CFI Function _R_WDT_Restart
          CFI NoCalls
        CODE
//   69 inline void R_WDT_Restart(void)
//   70 {
_R_WDT_Restart:
        ; * Stack frame (at entry) *
        ; Param size: 0
        ; Auto size: 0
//   71     WDTE = 0xACU;     /* restart watchdog timer */
...
//   72 }
        ...
        END
//   73 
//   74 /* Start user code for adding. Do not edit comment generated here */
//   75 /* End user code. Do not edit comment generated here */
// 
//  5 bytes in section .bss.noinit  (abs)
// 17 bytes in section .text
// 
