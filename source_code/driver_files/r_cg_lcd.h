...
Macro definitions
***********************************************************************************************************************/
#define LCD_REFVOLTAGE_WAITTIME           (0x3415U) /* wait for the reference voltage setup time (5 ms (min.)) */
#define LCD_VOLTAGE_WAITTIME              (0x145855U) /* voltage boost wait time (500 ms) */
